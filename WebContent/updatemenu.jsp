...
<body>
    ...
    <hr width="200"></hr>
    <form action="updatemenu1.jsp">
<table width="350" height="100" align="center" style="margin-top: 100px;style=color: #383838;">
<tr ><td >Item Id</td><td><input type="text" name="item4" value=""></td></tr>
</table><br/><br/>
<div align="center"><button style="background-color: #383838;color: white;padding: 5px;border-color: #383838"type="submit" id="but"><b>Update</b></button></div>    
</body>
</html>